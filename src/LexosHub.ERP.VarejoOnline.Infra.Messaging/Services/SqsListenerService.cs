...
namespace LexosHub.ERP.VarejoOnline.Infra.Messaging.Services
{
    public class SqsListenerService : BackgroundService
    {
        ...
        public SqsListenerService(//IAmazonSQS sqsClient, 
                                  ...
                                  ISqsRepository sqsRepository)
        {
            ...
            _sqsRepository.IniciarFila(configuration["VarejoOnline:PricetableSync"], Lexos.SQS.Models.TipoConta.Environment);
        }
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                foreach (var queueUrl in _queueUrls)
                {
                    ...
                    var mensagens = _sqsRepository.ObterMensagens<BaseEvent>();
                    _logger.LogInformation("SQS Buscou Fila");
